...
//     version 1.11.2
//     from Assets/[Project]/Scripts/Input/InputActions.inputactions
//
...
namespace BattleBots
{
    ...
    ""controlSchemes"": []
        ...
        ~@InputActions()
        {
            UnityEngine.Debug.Assert(!m_Mech.enabled, "This will cause a leak and performance issues, InputActions.Mech.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Pilot.enabled, "This will cause a leak and performance issues, InputActions.Pilot.Disable() has not been called.");
        }
