		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 panner15 = ( uv16 + 1.0 * _Time.y * float2( 0.05,0.05 ));
					...
					float2 panner5 = ( uv4 + 1.0 * _Time.y * float2( 0.04,0 ));
					float4 tex2DNode3 = tex2D( _TextureSample1, panner5 );
					float2 uv9 = i.texcoord * float2( 1,1 ) + float2( 0,0 );
					float2 panner8 = ( uv9 + 1.0 * _Time.y * float2( 0.08,-0.03 ));
					float4 tex2DNode2 = tex2D( _TextureSample0, panner8 );
					float lerpResult26 = lerp( tex2DNode3.g , tex2DNode2.g , 0.5);
					float lerpResult19 = lerp( ( tex2D( _TextureSample2, panner15 ).r * tex2DNode1.b ) , ( tex2DNode1.b * lerpResult26 ) , 0.4);
...
/*ASEBEGIN
Version=14301
2692;471;1722;915;2280.439;835.1796;1.909999;True;True
Node;AmplifyShaderEditor.Vector2Node;6;-1606.71,7.922191;Float;False;Constant;_Vector0;Vector 0;3;0;Create;True;0.04,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;7;-1601.088,255.0925;Float;False;Constant;_Vector1;Vector 1;3;0;Create;True;0.08,-0.03;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;14;-1616.008,-440.4619;Float;False;Constant;_Vector2;Vector 2;3;0;Create;True;0.05,0.05;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-303.8806,61.24392;Float;False;Property;_Intensity;Intensity;4;0;Create;True;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexColorNode;21;-181.2892,-230.3589;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;13.31894,-60.95605;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0.0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;143.7551,-1.422149;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0.0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMasterNode;0;330.6103,-56.75085;Float;False;True;2;Float;ASEMaterialInspector;0;5;VFX_Clouds_Bits_Dark;0b6a9f8b4f707c74ca64c0be8e590de0;Particles Alpha Blended;2;SrcAlpha;OneMinusSrcAlpha;0;One;Zero;Off;True;True;True;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=24F4B1148F33AF7B421564CAA6F77D40076DE65D