		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					fixed4 col = ( ( i.color * ( tex2D( _VFX_CentreLight_Bit1_Bit2, uv_VFX_CentreLight_Bit1_Bit2 ).g * _Intensity ) ) * i.color.a );
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-57,-90.5;Float;False;2;2;0;COLOR;0.0;False;1;FLOAT;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-36,35.5;Float;False;2;2;0;COLOR;0.0;False;1;FLOAT;0.0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMasterNode;1;152,-55;Float;False;True;2;Float;ASEMaterialInspector;0;5;VFX_Bit1;0b6a9f8b4f707c74ca64c0be8e590de0;Particles Alpha Blended;4;One;One;0;One;Zero;Off;True;True;True;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=72FD35678FA2B1585E0BE06AEDE302ACAB057979