		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					fixed4 col = ( ( i.color * ( tex2D( _VFX_Fire1_2_3, uv_VFX_Fire1_2_3 ).g * _Intensity ) ) * i.color.a );
...
Node;AmplifyShaderEditor.TemplateMasterNode;0;0,0;Float;False;True;2;Float;ASEMaterialInspector;0;5;VFX_Fire_2;0b6a9f8b4f707c74ca64c0be8e590de0;Particles Alpha Blended;4;One;One;0;One;Zero;Off;True;True;True;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=58262E334A8ACDEE671368EAB3CCC18FEAE8C2CC